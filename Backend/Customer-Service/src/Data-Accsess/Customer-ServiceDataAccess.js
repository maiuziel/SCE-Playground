...
const insertCustomer = async ({ full_name, password, phone, email }) => {
  const result = await pool.query(
    "INSERT INTO customers (full_name, password, phone, email) VALUES ($1, $2, $3, $4) RETURNING *",
...
const updateCustomer = async (id, { full_name, password, phone, email }) => {
  const result = await pool.query(
    "UPDATE customers SET full_name = $1, password = $2, phone = $3, email = $4 WHERE id = $5 RETURNING *",
